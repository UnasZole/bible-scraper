...
import static com.github.unaszole.bible.datamodel.idtypes.BibleIds.*;
...
public enum BibleContainers implements ContextType {
     ...
     */
    VERSE(VERSE_ID, STRING, EMPTY_STR, atLeastOne(StructureMarkers.STRUCTURED_TEXT, PSALM_TITLE)),
     ...
     */
    CHAPTER(CHAPTER_ID, STRING, EMPTY_STR, atMostOne(CHAPTER_TITLE), atMostOne(CHAPTER_INTRO), atMostOne(PSALM_TITLE), atMostOne(StructureMarkers.STRUCTURED_TEXT), atLeastOne(VERSE)),
     ...
     */
    BOOK(BOOK_ID, BIBLE_BOOK, NO_IMPLICIT, atMostOne(BOOK_TITLE), atMostOne(BOOK_INTRO), atLeastOne(CHAPTER)),
