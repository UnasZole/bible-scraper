...
public enum ContextType {
	...
	MINOR_SECTION_TITLE(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	SECTION_TITLE(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	MAJOR_SECTION_TITLE(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	 ...
	 */
	STRUCTURED_TEXT(NO_ID, NO_VALUE, NULL, any(FLAT_TEXT, STRUCTURE_MARKER)),
	 ...
	 * one single title.
	 */
	PSALM_TITLE(NO_ID, NO_VALUE, NULL, one(FLAT_TEXT)),
	 ...
	 */
	VERSE(BIBLE_VERSE, STRING, EMPTY_STR, atLeastOne(STRUCTURED_TEXT, PSALM_TITLE)),
	
	CHAPTER_INTRO(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	CHAPTER_TITLE(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	/**
	 * A chapter.
	 ...
	 */
	CHAPTER(BIBLE_CHAPTER, STRING, EMPTY_STR, atMostOne(CHAPTER_TITLE), atMostOne(CHAPTER_INTRO), atMostOne(PSALM_TITLE), atMostOne(STRUCTURED_TEXT), atLeastOne(VERSE)),

	BOOK_INTRO_TITLE(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	BOOK_INTRO(NO_ID, NO_VALUE, NULL, atMostOne(BOOK_INTRO_TITLE), one(STRUCTURED_TEXT)),
	BOOK_TITLE(NO_ID, NO_VALUE, NO_IMPLICIT, one(FLAT_TEXT)),
	/**
	 * A book.
	...
	BIBLE(NO_ID, NO_VALUE, NULL, atLeastOne(BOOK));
	...
	*/
	...
	ContextType(IdType idType, ValueType valueType, ImplicitValue implicitValue, ContextSequence... allowedChildren) {
